        ...
        <div id="wd-bs-responsive-grids">
            ...
            <div className="row">
                <div className="col-12 col-md-6 col-xl-3 
                                bg-warning">
                <h3>Column A</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, eius velit labore eligendi molestias libero, ipsam harum facere rem provident, inventore necessitatibus dolorum enim voluptate numquam qui explicabo. Deleniti, omnis!</p>
                </div>
                <div className="col-12 col-md-6 col-xl-3 
